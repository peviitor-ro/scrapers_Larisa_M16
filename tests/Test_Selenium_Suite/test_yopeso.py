...
@pytest.mark.regression
@pytest.mark.ui
def test_yopeso_titles_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_yopeso_titles_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_yopeso_link_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_yopeso_link_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_yopeso_company_ui(get_job_details, scrape_ui):
