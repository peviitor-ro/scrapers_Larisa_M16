...
@pytest.mark.API
def test_catena_job_count_api(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_catena_titles_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_catena_titles_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_catena_link_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_catena_link_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_catena_company_ui(get_job_details, scrape_ui):
