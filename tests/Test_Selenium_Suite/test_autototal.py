...
@pytest.mark.API
def test_autototal_job_count_api(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_autototal_titles_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_autototal_titles_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_autototal_link_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_autototal_link_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_autototal_company_ui(get_job_details, scrape_ui):
