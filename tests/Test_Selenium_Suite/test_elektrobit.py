...
@pytest.mark.API
def test_elektrobit_job_count_api(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_elektrobit_titles_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_elektrobit_titles_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_elektrobit_link_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_elektrobit_link_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_elektrobit_company_ui(get_job_details, scrape_ui):
