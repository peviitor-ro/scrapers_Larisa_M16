...
@pytest.mark.API
def test_bandainamco_job_count_api(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_bandainamco_titles_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_bandainamco_titles_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_bandainamco_link_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_bandainamco_link_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_bandainamco_company_ui(get_job_details, scrape_ui):
