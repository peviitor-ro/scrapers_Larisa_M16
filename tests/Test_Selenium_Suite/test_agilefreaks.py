...
@pytest.mark.API
def test_agilefreaks_job_count_api(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_agilefreaks_titles_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_agilefreaks_titles_ui(get_job_details, scrape_ui):
...
# @pytest.mark.regression
# @pytest.mark.ui
# def test_agilefreaks_city_scraper(get_job_details, scrape_ui):
#     allure.dynamic.title(f"Test job cities from the {company_name} website against Peviitor ui Response")
...
#     with allure.step("Step 2: Get job cities from the Peviitor ui"):
#         # Grab the data from peviitor ui
#         testutils, job_details = scrape_ui[0], scrape_ui[1]
        
#         job_cities_peviitor = job_details[1]
#         # job_titles_peviitor = job_details[0]
#         job_titles_elements = job_details[4]

#     with allure.step("Step 3: Compare job cities from scraper response against Peviitor ui Response"):
...
#         testutils.check_scraper_job_cities(job_cities_scraper, job_cities_peviitor, job_titles_scraper, job_titles_elements)

# @pytest.mark.regression
# @pytest.mark.ui
# def test_agilefreaks_city_ui(get_job_details, scrape_ui):
#     allure.dynamic.title(f"Test job cities from the Peviitor ui against the {company_name} website")
...
#     with allure.step("Step 3: Compare job cities from the Peviitor ui against the company website"):
#         allure.attach(f"Expected Results: {job_cities_scraper}", name="Expected Results")
#         allure.attach(f"Actual Results: {job_cities_peviitor}", name="Actual Results")
#         testutils.check_peviitor_job_cities(job_cities_scraper, job_cities_peviitor, job_titles_peviitor, job_titles_elements)

@pytest.mark.regression
@pytest.mark.ui
def test_agilefreaks_link_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_agilefreaks_link_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_agilefreaks_company_ui(get_job_details, scrape_ui):
