...
@pytest.mark.API
def test_emia_job_count_api(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_emia_titles_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_emia_titles_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_emia_link_scraper(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_emia_link_ui(get_job_details, scrape_ui):
...
@pytest.mark.regression
@pytest.mark.ui
def test_emia_company_ui(get_job_details, scrape_ui):
