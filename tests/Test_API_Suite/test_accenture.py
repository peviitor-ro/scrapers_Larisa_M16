...
from sites.accenture_scraper import scraper as accentureScraper
import pytest
import allure
...
@pytest.mark.API
def test_accenture_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_accenture_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_accenture_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_accenture_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_accenture_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_accenture_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_accenture_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_accenture_company_api(get_job_details):
