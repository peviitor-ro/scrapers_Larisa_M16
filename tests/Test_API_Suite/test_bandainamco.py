...
def get_job_details():
    ...
    """
    scraper_data = bandainamcoScraper()
    testutils = TestUtils()
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_job_count_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_title_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_special_title_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_city_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_country_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_type_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_format_type_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_link_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_status_code_link_api(get_job_details):
...
@pytest.mark.API
@pytest.mark.skip
def test_bandainamco_company_api(get_job_details):
