...
@pytest.mark.API
def test_emia_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_emia_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_emia_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_emia_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_emia_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_emia_company_api(get_job_details):
