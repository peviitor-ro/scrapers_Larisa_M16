...
@pytest.mark.regression
@pytest.mark.API
def test_agilefreaks_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_agilefreaks_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_agilefreaks_format_type_api(get_job_details):
