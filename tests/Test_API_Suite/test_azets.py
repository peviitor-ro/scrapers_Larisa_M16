...
@pytest.mark.API
def test_azets_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_azets_company_api(get_job_details):
