...
@pytest.mark.API
def test_canamgroup_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canamgroup_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canamgroup_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canamgroup_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canamgroup_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_canamgroup_format_type_api(get_job_details):
