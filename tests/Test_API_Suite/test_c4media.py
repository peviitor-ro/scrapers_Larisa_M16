...
@pytest.mark.API
def test_c4media_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_c4media_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_c4media_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_c4media_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_c4media_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_c4media_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_c4media_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_c4media_company_api(get_job_details):
