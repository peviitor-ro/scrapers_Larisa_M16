...
@pytest.mark.API
def test_bunge_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bunge_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bunge_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bunge_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bunge_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bunge_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bunge_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bunge_company_api(get_job_details):
