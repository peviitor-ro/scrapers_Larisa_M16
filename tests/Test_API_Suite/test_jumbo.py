...
from sites.jumbo_scraper import scraper as jumboScraper
import pytest
import allure
...
@pytest.mark.API
def test_jumbo_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_jumbo_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_jumbo_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_jumbo_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_jumbo_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_jumbo_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_jumbo_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_jumbo_company_api(get_job_details):
