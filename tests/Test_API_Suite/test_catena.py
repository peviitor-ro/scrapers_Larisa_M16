...
@pytest.mark.API
def test_catena_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_catena_company_api(get_job_details):
