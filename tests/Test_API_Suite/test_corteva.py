...
@pytest.mark.API
def test_corteva_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_corteva_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_corteva_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_corteva_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_corteva_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_corteva_status_code_link_api(get_job_details):
