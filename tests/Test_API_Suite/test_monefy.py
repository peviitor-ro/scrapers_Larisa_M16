...
@pytest.mark.API
def test_monefy_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_monefy_status_code_link_api(get_job_details):
