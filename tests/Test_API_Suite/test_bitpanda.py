...
@pytest.mark.API
def test_bitpanda_job_count_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_special_title_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_city_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_country_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_format_type_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_status_code_link_api(get_job_details):
...
@pytest.mark.regression
@pytest.mark.API
def test_bitpanda_company_api(get_job_details):
