...
from  __utils.req_bs4_shorts import GetStaticSoup, GetRequestJson, PostRequestsJson, HackCloudFlare,GetXMLObject
from  __utils.req_bs4_shorts import GetHtmlSoup
